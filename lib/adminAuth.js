...
const otpauthUrl = (email, secret) =>
  `otpauth://totp/${encodeURIComponent(`Call Me Maybe Admin:${email}`)}?secret=${secret}&issuer=${encodeURIComponent("Call Me Maybe Admin")}&algorithm=SHA1&digits=6&period=30`;
